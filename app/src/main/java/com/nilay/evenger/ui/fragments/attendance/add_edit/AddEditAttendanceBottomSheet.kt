...
import com.nilay.evenger.databinding.BottomSheetAddEditBinding
...
import com.nilay.evenger.utils.getAndSetHint
...
//                }
    ...
    private fun setHintTeacher(): String =
            when {
                ...
                else -> if (viewModel.attendance.teacher == "") resources.getString(R.string.no_teacher_name)
